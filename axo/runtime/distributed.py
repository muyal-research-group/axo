...
class DistributedRuntime(ActiveXRuntime,Thread):
    def __init__(
        ...
        *,
        ...
        self.__storage_service = storage_service if storage_service else MictlanXStorageService(protocol=default_storage_service_params.get("protocol","http"),client=default_storage_service_params.get("client",None),routers_str=default_storage_service_params.get("routers_str","") )
